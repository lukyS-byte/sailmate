...
export default function Modal({ title, onClose, children, size = 'md', hideClose = false }) {
  useEffect(() => {
  ...
  return (
    <div
      ...
      onClick={(e) => !hideClose && e.target === e.currentTarget && onClose()}
    >
      <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={hideClose ? undefined : onClose} />
